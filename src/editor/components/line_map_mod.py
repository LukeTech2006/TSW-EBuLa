...
class LineMapMod(customtkinter.CTkFrame):
    def __init__(self, master, item_count:int = 5, **kwargs):
        self.comp = super().__init__(master, **kwargs)
        ...
        self.main_frame = customtkinter.CTkScrollableFrame(self.comp,width=500,height=500)
