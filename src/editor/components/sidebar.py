...
class Sidebar(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        # self = customtkinter.CTkFrame(master, corner_radius=0)
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(self, command=self.add_poi)
        ...
        self.settings_panel = SettingPanel(self)
